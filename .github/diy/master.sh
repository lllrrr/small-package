...
git clone --depth 1 https://github.com/fw876/helloworld && mv -n helloworld/{luci-app-ssr-plus,dns2socks-rust,dns2tcp,gn,lua-neturl,redsocks2,shadow-tls,trojan} ./; rm -rf helloworld
